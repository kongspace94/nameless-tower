...
const SKILLS={
  ...
  dragon_fang:{n:"용아파",emoji:"🐲",type:"active",mp:10,rare:true,src:"boss",desc:"용의 이빨 필살 강타 + 대형 그로기 (타이밍)",fx:{hits:1,mult:3.1,groggy:35,color:"#ff8f3c",popup:"용아!",shake:true,timing:true}},
  soul_reap:{n:"영혼 수확",emoji:"💀",type:"active",mp:9,rare:true,src:"boss",desc:"적 HP 40%↓면 영혼째 베어낸다 (타이밍)",fx:{execMult:6,execThresh:0.4,mult:1.5,color:"#c96ad6",timing:true}},
  blizzard:{n:"블리자드",emoji:"❄️",type:"active",mp:10,rare:true,src:"farm",desc:"눈보라 — 냉기 대마법 + 적 약화 (타이밍)",fx:{magic:true,mult:2.5,elem:"frost",enemyWeak:0.2,color:"#8fd0ff",timing:true}},
  thunderclap:{n:"뇌명",emoji:"⚡",type:"active",mp:10,rare:true,src:"farm",desc:"낙뢰 — 감전 마법 + 기절 확률 (타이밍)",fx:{magic:true,mult:2.3,elem:"shock",stun:0.45,stunBoss:0.2,timing:true}},
  ...
  life_siphon:{n:"생명 착취",emoji:"🩸",type:"active",mp:9,rare:true,src:"boss",desc:"마법 피해 + 60% 흡혈 (타이밍)",fx:{magic:true,mult:1.9,vamp:0.6,color:"#c96ad6",timing:true}},
  guillotine:{n:"단두대",emoji:"🪓",type:"active",mp:10,rare:true,src:"farm",desc:"거대 참수 — 낮은 HP 적 특효 (타이밍)",fx:{execMult:4,execThresh:0.35,mult:2.3,color:"#ff5a5a",shake:true,timing:true}},
  holy_smite:{n:"천벌",emoji:"🌟",type:"active",mp:10,rare:true,src:"boss",desc:"신성한 심판 — 방어 무시 대타격 (타이밍)",fx:{hits:1,mult:2.9,defIgnore:true,color:"#ffe08a",popup:"천벌!",timing:true}},
  ...
  self_destruct:{n:"자폭 인형",emoji:"🧨",type:"active",mp:7,rare:true,src:"boss",desc:"HP를 크게 태워 방어 무시 초대형 폭발 (타이밍)",fx:{hits:1,mult:4.6,defIgnore:true,selfHpCost:0.2,popup:"BOOM!",popColor:"#ff5a5a",shake:true,timing:true}},
...
const WEAPONS={
  ...
  sword: {n:"검",    hits:1, mult:1.00, crit:0.00, groggy:10, gauge:1.00, ic:"⚔", mg:"slash"},    // 연속 베기 콤보 — 3연타 리듬, 연속 정타로 콤보 가속(플로우)
