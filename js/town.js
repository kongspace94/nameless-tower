...
/* ============================================================
   거점 마을
   ============================================================ */
function townMenu(){ mode="town"; enemy=null; B=null; stopAuctionTimer(); stopChatTimer(); auction=null; EXP=null; expReturn=null; P.buffs={}; checkTitleUnlocks(); checkQuests();
